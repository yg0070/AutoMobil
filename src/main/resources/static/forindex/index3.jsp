...
<body>
	<div class="col-md-7 centered"
		style='background-color: #71CBAD;width: 100%; '>
		<div id="test3-container" style="height: 310px;">
			<ul id="test3"  style="margin-top: 10px;">
			
			</ul>
			<i class="fa fa-arrow-down" id="tests3-next" style='margin-top: 10;  MARGIN-RIGHT: 55PX;'></i>
			<i class="fa fa-arrow-up" id="tests-prev" style='margin-top: 20;'></i>
		</div>
	</div>
 ...
 */
		...
		var nt_example1 = $('#test3').newsTicker({
			row_height : 110,
			max_rows : 3,
			duration : 4000,
			prevButton : $('#test3-prev'),
			nextButton : $('#test3-next')
		});
