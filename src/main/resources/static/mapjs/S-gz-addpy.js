...
var _carno;
var dbna;
function fuzhi(carno,dbname){
	_carno=carno
	dbna=dbname;
}
function startload(){
	$.ajaxSettings.async = false;   
	$.getJSON("map.do?method=getmarksid&carno="+_carno+"&dbname="+dbna, function(json) {
...
function showzdinfo(e){//显示站点信息
	...
	$.getJSON("map.do?method=getallremarkbydname",{"dname":dbna}, function(json) {
			if(json[0]!=""){
				var opts = {
