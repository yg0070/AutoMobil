...
! function () {
    layer.config({
        extend: [
        'extend/layer.ext.js'/*tpa=http://www.zi-han.net/theme/hplus/js/demo/extend/layer.ext.js*/, 'skin/moon/style.css'/*tpa=http://www.zi-han.net/theme/hplus/js/demo/skin/moon/style.css*/
    ],
        skin: 'layer-ext-moon'
    });
    var gather = {
    ...
    $('#chutiyan>a').on('click', function () {
        ...
        case 16:
            if (gather.photoJSON) {
                ...
                $.getJSON('http://www.zi-han.net/theme/hplus/js/demo/js/demo/photos.json?v=', function (json) {
