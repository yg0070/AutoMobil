...
(function($) {
	...
	jQuery.fn.MyDigitClock.defaults = {
		...
		fontColor: '#777777',
		fontWeight: 'bold',
		timeFormat: '{HH}<span id="ch1" style="display:inline-block;margin-left: 5px;margin-right: 5px;font-size: 13px;">:</span>{MM}<span id="ch2" style="height:40px;display:inline-block;margin-left: 5px;margin-right: 5px;font-size: 13px;">:</span>{SS}',
