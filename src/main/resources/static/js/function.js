$(function(){
	...
	for ( var i = 0; i < fs.length; i++) {
		if (fs[i] == "添加") {
			...
			$("#tb").append("<a href='remarkMap.do?method=getRemarkMap' class='easyui-linkbutton' id='tbadd' data-options=\"iconCls:\'icon-add\',plain:true\">新增</a>");
		}else if (fs[i] == "授权") {
			$("#tb").append("<a href='javascript:void(0)' class='easyui-linkbutton' id='tbshouquan' onclick='shouquan()' data-options=\"iconCls:\'icon-edit\',plain:true\">授权</a>");
		}else if (fs[i] == "竞价") {
			$("#tb").append("<a href='javascript:void(0)' class='easyui-linkbutton' id='tbjingjia' onclick='jingjia()' data-options=\"iconCls:\'icon-add\',plain:true\">竞价</a>");
		}
		else if (fs[i] == "车辆共享") {
			$("#tb").append("<a href='javascript:void(0)' class='easyui-linkbutton' id='tbgongxiang' onclick='gongxiang()' data-options=\"iconCls:\'icon-edit\',plain:true\">车辆共享</a>");
		}
	}
