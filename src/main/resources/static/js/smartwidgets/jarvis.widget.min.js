(function($, window, document, undefined) {
	...
	Plugin.prototype = {
			...
			self.widget.each(function() {
				...
				if (!thisHeader.parent().attr("role")) {
					...
					if (self.o.deleteButton === true && tWidget.data("widget-deletebutton") === undefined) {
						var deleteBtn = '<a href="javascript:void(0);" class="button-icon jarviswidget-delete-btn" rel="tooltip" title="删除" data-placement="bottom"><i class="' + self.o.deleteClass + '"></i></a>'
					} else {
						deleteBtn = ""
					}
					...
					if (self.o.fullscreenButton === true && tWidget.data("widget-fullscreenbutton") === undefined) {
						var fullscreenBtn = '<a href="javascript:void(0);" class="button-icon jarviswidget-fullscreen-btn" rel="tooltip" title="全屏" data-placement="bottom"><i class="' + self.fullscreenClass[0] + '"></i></a>'
					} else {
						fullscreenBtn = ""
					}
					...
					if (self.o.toggleButton === true && tWidget.data("widget-togglebutton") === undefined) {
						...
						var toggleBtn = '<a href="#" class="button-icon jarviswidget-toggle-btn" rel="tooltip" title="缩放" data-placement="bottom"><i class="' + toggleSettings + '"></i></a>'
					} else {
						toggleBtn = ""
					}
		...
		_clickEvents: function() {
			...
			function(e) {
				$(this).closest('iframe').addClass('splashScreen');
