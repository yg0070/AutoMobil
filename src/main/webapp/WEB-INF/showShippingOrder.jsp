			...
			<div class="head_wrapper">
				<div class="s_form">
					<div class="s_form_wrapper">
						<div id="lg">
							<img hidefocus="true" src="/TMS/images/supmaxlogo.png"
								width="270" height="129">
						</div>
						<a href="/TMS/souShip.do?method=index" id="result_logo"
							onmousedown="return c({'fm':'tab','tab':'logo'})"><img
							src="/TMS/images/supmaxlogo.png" alt="到速搜首页" title="到速搜首页"></a>
				...
				if(pid!=""&&pid!=null){
					$.ajax({
						   ...
						   success: function(msg){
							   ...
							   if(msg==""){
								   $("#deta").append("<tr><td id='error'>*抱歉！未查到此运单"+pid+"信息，请确认运单号码是否正确，或致电速迈。</td></tr>");
							   }
						   }
