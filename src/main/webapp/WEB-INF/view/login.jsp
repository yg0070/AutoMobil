    ...
    <script type="text/javascript">
        window.onload = function () {
            var qrcode = new QRCode('code', {
                text: 'http://103.239.152.68:8855/truck_cloud/apk/TruckCloud.apk',
                width: 100,
                height: 100,
                colorDark: '#000000',
                colorLight: '#ffffff',
...
/*            $("#code").qrcode({
                text: "http://103.239.152.68:8855/truck_cloud/apk/TruckCloud.apk",//"www.baidu.com", //任意内容
...
/*            $(".radio").change(function () {
        ...
        function radioChange(radioValue2){
        ...
        <div class="login">
            ...
            <div class="iner">
                ...
                <form action="login.do" id="myform" method="post" autocomplete="off">
                    ...
                    <div class="user"><i></i><input type="text" name="username" id="username" placeholder="请输入用户名"/>
                    </div>
                    <div class="password"><i></i><input type="password" name="password" id="password"
                                                        placeholder="请输入密码"/></div>
                    <div class="code"><i></i>
                        <jsp:include page="verifycode.jsp"></jsp:include>

                    </div>
                    <div class="input">
                        <input class="gongyingshang" id="form_button" onclick="loginUser()" value="登录"
                               type="button"></input>
                    </div>
                    <div id="code"></div>
                </form>
